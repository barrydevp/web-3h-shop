...
import {faShoppingBasket, faIdBadge, faBolt} from '@fortawesome/free-solid-svg-icons'
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse navbar-shop-collapse">
                        <ul class="nav navbar-nav">
                            <li class="icon-flash">
                                <a href="#">Flash <FontAwesomeIcon dx={2} icon={faBolt}/> Sale</a>
                            </li>
                            <li><a href="#">Shop</a></li>
                        </ul>
                        <div class="nav navbar-nav navbar-right">
                            <div class="hotline clearfix pull-right d-none d-lg-block">
                                <div class="hotline-icon">
                                    <FontAwesomeIcon dx={2} icon={faIdBadge}/>
                                </div>
                            ...
                            <div class="bag-cart">
                                <a href="cart.html"><FontAwesomeIcon dx={2} icon={faShoppingBasket}/><sup>3</sup></a>
                            </div>
                        </div>
                    </div>
                </div>
